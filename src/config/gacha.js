...
export const GACHA_REWARDS = Object.freeze({
  ...
  rare: Object.freeze([
    Object.freeze({ id: 'rare-character', kind: 'character', label: '进阶字（全池）', weight: 45, selection: 'any', duplicateAmount: 120 }),
    Object.freeze({ id: 'rare-item', kind: 'item', label: '战术道具 +1 级', weight: 35, levels: 1 }),
    Object.freeze({ id: 'rare-gold', kind: 'gold', label: '军饷 200 金', weight: 20, amount: 200 }),
  ]),
  precious: Object.freeze([
    Object.freeze({ id: 'precious-character', kind: 'character', label: '进阶字（未解锁优先）', weight: 45, selection: 'locked-first', duplicateAmount: 400 }),
    Object.freeze({ id: 'precious-item', kind: 'item', label: '珍贵道具 +2 级', weight: 35, levels: 2 }),
    Object.freeze({ id: 'precious-gold', kind: 'gold', label: '军饷 600 金', weight: 20, amount: 600 }),
  ]),
});
